...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        set_btn = findViewById(R.id.setting);
    ...
    public void queryAll() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.putExtra(NotePadDB.TITLE, cursor.getString(cursor.getColumnIndex(NotePadDB.TITLE)));
                intent.putExtra(NotePadDB.AUTHOR, cursor.getString(cursor.getColumnIndex(NotePadDB.AUTHOR)));
